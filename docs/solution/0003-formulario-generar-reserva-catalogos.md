# ADR-0003: Formulario "Generar Reserva" — arquitectura personalizada con catálogos configurables

## Estado
Aceptado

## Contexto
- Apps Script permite incrustar formularios HTML personalizados (la pantalla "Generar Reserva", definida en ADR-0002) en lugar de usar Google Forms.
...
| `Catálogo_Servicios_Extra` | Espacio, Nombre_Servicio, Activo | Servicios extra disponibles por espacio |
...
5. **Servicios extra**: checklist filtrado por el Espacio elegido, desde `Catálogo_Servicios_Extra` (solo activos). De momento sin coste asociado — puramente informativo/operativo.
...
- Definir si los Servicios Extra tendrán coste asociado en una iteración futura.
